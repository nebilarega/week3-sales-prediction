...
nav_image = plt.imread('images/10aclogo.png')
st.sidebar.image(nav_image, use_column_width=True)

# navbar content-1
html3 = '''
<h2 style="text-align: center;">Sales Prediction</h2>
<p style="text-align: center; font-size: 15px">This project is part of 10Academy week3 project -
 sales prediction using Rossmann data
<hr class="rounded">
'''
